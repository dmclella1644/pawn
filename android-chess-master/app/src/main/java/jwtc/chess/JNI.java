...
//				{"br","wr","br","wr","wp","bp","wp","bp"},
//				{"wq","bq","wq","bq","wk","bk","bp","wp"},
//				{"ee","ee","ee","ee","ee","ee","ee","ee"},
//				{"ee","ee","ee","ee","ee","ee","ee","ee"},
//				{"ee","ee","ee","ee","ee","ee","ee","ee"},
//				{"ee","ee","ee","ee","ee","ee","ee","ee"}};
		...
		for(int i=0;i<64;i++){
			...
			int piece_color=-1;
			int curr_pos = i;
			String curr_s = values[i];
			String color = curr_s.substring(0,1);
			String piece = curr_s.substring(1,2);
			switch(color){
				case("b"):
					piece_color = BoardConstants.BLACK;
					break;
				case("w"):
					piece_color = BoardConstants.WHITE;
					break;
				case("e"):
					break;
				default:
					throw new IllegalArgumentException("Not Black/White");
			}

			switch(piece){
				case "b":
					piece_id = BoardConstants.BISHOP;
					break;
				case "n":
					piece_id = BoardConstants.KNIGHT;
					break;
				case "k":
					piece_id = BoardConstants.KING;
					break;
				case "r":
					piece_id = BoardConstants.ROOK;
					break;
				case "p":
					piece_id = BoardConstants.PAWN;
					break;
				case "q":
					piece_id = BoardConstants.QUEEN;
					break;
				case "e":
					break;
				default:
					throw new IllegalArgumentException("Not valid piece id");
			}
			if(piece_id!=-1 && piece_color!=-1){
				putPiece(curr_pos, piece_id, piece_color);
			}
		}
