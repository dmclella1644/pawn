...
class Model:
    def __init__(self):
    # Fix the file sources later
        self.model_file = 'pawn_graph.pb'
        self.label_file = 'pawn_labels.txt'
    ...
    def labelImage(self, image):
        ...
        t = self.read_tensor_from_image_file(image,
        ...
        #Return label of the top result
